...
public class CursorAdapter_Produtos_Adicionados_Historico extends CursorAdapter {
    SQLiteOpenHelper db_h;
    SQLiteDatabase db;

    public CursorAdapter_Produtos_Adicionados_Historico(Context context, Cursor cursor) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.lista_produtos_comprar_historico_row, parent, false);
    }
